...
func (o *PortForwardOptions) Complete(f cmdutil.Factory, args []string) error {
	...
	forwardablePod, err := polymorphichelpers.AttachablePodForObjectFn(f, obj, defaultPodPortForwardWaitTimeout)
	if err != nil {
		return err
	}
...
// RunPortForward is a function to run port forward after all validatios
...
//GetPorts to obtain binded ports
func (o *PortForwardOptions) GetPorts() ([]portforward.ForwardedPort, error) {
	return o.PortForwarder.GetPorts()
}
